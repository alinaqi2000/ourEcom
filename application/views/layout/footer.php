<footer class="ps-footer">
    <div class="ps-container">
        <div class="ps-footer__widgets">
            <aside class="widget widget_footer widget_contact-us">
                ...
                <div class="widget_content">
                    <p>Call us 24/7</p>
                    <h3>1800 97 97 69</h3>
                    <p>502 New Design Str, Melbourne, Australia <br><a href="http://nouthemes.net/cdn-cgi/l/email-protection#caa9a5a4beaba9be8aa7abb8beacbfb8b3e4a9a5"><span class="__cf_email__" data-cfemail="22414d4c56434156624f4350564457505b0c414d">[email&#160;protected]</span></a></p>
        ...
        <div class="ps-footer__copyright">
            ...
            <p><span>We Using Safe Payment For:</span><a href="#"><img src="<?= base_url("assets/") ?>img/payment-method/1.jpg" alt=""></a><a href="#"><img src="<?= base_url("assets/") ?>img/payment-method/2.jpg" alt=""></a><a href="#"><img src="<?= base_url("assets/") ?>img/payment-method/3.jpg" alt=""></a><a href="#"><img src="<?= base_url("assets/") ?>img/payment-method/4.jpg" alt=""></a><a href="#"><img src="<?= base_url("assets/") ?>img/payment-method/5.jpg" alt=""></a></p>
        </div>
    </div>
</footer>
